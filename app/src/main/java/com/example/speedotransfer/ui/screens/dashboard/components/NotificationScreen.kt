...
@Composable
fun NotificationScreen(navController: NavController, modifier: Modifier = Modifier,innerPadding :PaddingValues) {
        ...
        Row (
            ...
            Box(
                modifier = Modifier
                    ...
                    .shadow(1.dp, RoundedCornerShape(10.dp), clip = false) // Apply shadow to the box
                    .background(LightPink, RoundedCornerShape(10.dp)) // Set the background with the same shape
            ) {
                Icon(
            ...
            Column(modifier = modifier
                ...
                Text(text = notificationItemData.date, fontSize = 12.sp,fontWeight = FontWeight.Normal,
                    color = Grey)
